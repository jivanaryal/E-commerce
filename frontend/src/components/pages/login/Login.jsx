...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-thirdColor ">
      <div className="bg-white p-6 px-20 h-fit w-fit rounded-md shadow-lg shadow-secondColor">
                  ...
                  return (
                    <div key={i} className="">
                      <div className="grid grid-cols-1 place-content-center p-2">
                        <label htmlFor={val.name} className="grid grid-rows-1 ">
                          {val.label}
                        </label>
                        <div className="flex flex-col">
                          <div>
                            ...
                            <Field
                              ...
                              className="border-2  rounded-sm outline-none p-2  px-5 text-sm"
                            />
                          </div>
                          {/* <ErrorMessage
                            name={val.name}
